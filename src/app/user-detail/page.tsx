      ...
      if(newList.length===0){
        ...
        return newList.map((items:ProductGetLocal,index:number)=>{
          ...
          <div key={items.key} className="mt-7 flex">
           <img src={items.image} alt={`hang${items.key}`} width={100} height={100}/>
           <div className="pl-3">
  ...
  return (
    <div className="bg-white py-16">
      <div className="container mx-auto">
        <Row>
        <Col span={12} className="pr-7 bg-white py-3 rounded-md h-auto" >
        ...
        <Card style={{width:"400px"}}>
            <div className='flex justify-center'><img src="./img/logo.png" width={70} alt="logo" /></div>
          
            <div className='flex flex-col items-center font-[500]'>
                <p>Tổng thanh toán</p>
                <p>{avgProduct().toFixed(2)} $</p>
            </div>
            <Button onClick={()=>{saveProduct(null)}} className='w-full my-5 py-2 bg-[#ffd814] rounded-[15px] button-authen '>Thanh toán</Button>
            <Link className='w-full py-1.5 bg-[#ffa41c] rounded-[15px] inline-block text-center' href={"/carts"}>Quay lại giỏ hàng</Link>
